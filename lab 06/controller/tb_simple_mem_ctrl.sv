...
module tb_simple_mem_ctrl;
    ...
    // ******* Mailboxes and internal variables ********
    ...
    // Driver end-of-tests flagdut (.*)
    bit driver_done = 0;
    // Checker completion flag
    bit checker_done = 0;

    //****** Clock, Reset, and Testbench processes (Generator/Driver/Monitor/Checker) ******
    ...
    task automatic tb_generator();
        ...
        //both masters request the same time
