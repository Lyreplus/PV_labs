...
However, I decided to implement a single agent, because both channels share the same clock and reset signals, and the size of the module itself is relatively compact.

The following diagram shows the UVM architecture that I implemented.

\begin{figure}[H]
    \centering
    \includesvg[width=0.9\columnwidth]{diagram.svg}
