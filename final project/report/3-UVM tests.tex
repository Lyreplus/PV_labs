...
The command line examples to run each of the tests are provided in the next section (Functional Coverage Report).

\subsection{Smoke (or bring-up) Test (\texttt{gcd\_smoke\_test})}
